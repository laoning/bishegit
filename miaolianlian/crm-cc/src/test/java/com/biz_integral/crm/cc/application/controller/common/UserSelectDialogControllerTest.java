...
/**
 * ユーザ選択ダイアログコントローラのテストクラスです。<br/>
 */
@RunWith(BizIntegralTest.class)
public class UserSelectDialogControllerTest {

    /**
     * テスト対象です
     */
    protected UserSelectDialogController userSelectDialogController;
    ...
    public void testInitialize() {
        ...
        UserDialogInitializeResponseModel model =
            userSelectDialogController.initialize();
    ...
    public void testFilter() {
        ...
        PagingResponse<UserDialogFilterResponseModel> result =
            userSelectDialogController.filter(request);
