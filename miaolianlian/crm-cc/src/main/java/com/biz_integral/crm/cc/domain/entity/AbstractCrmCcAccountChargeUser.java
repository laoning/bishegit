...
public abstract class AbstractCrmCcAccountChargeUser implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAccountChargeUser() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccountChargeUser> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
