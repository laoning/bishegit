...
@Generated(
    ...
    date = "2010/08/18 15:30:53"
)
public abstract class AbstractBizSkcs implements Serializable {
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractBizSkcs> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
