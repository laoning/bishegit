...
/**
 * {@link AbstractImmDepartment}のプロパティ名の集合です。
 * 
 */
@Generated(value = {
    "S2JDBC-Gen unknown",
    "org.seasar.extension.jdbc.gen.internal.model.NamesModelFactoryImpl" }, date = "2010/07/23 9:20:52")
public class ImmDepartmentNames {
    ...
    /**
     * departmentShortNameのプロパティ名を返します。
     * 
     * @return departmentShortNameのプロパティ名
     */
    public static PropertyName<String> departmentShortName() {
        return new PropertyName<String>("departmentShortName");
    }

    /**
     * departmentSearchNameのプロパティ名を返します。
     * 
     * @return departmentSearchNameのプロパティ名
     */
    public static PropertyName<String> departmentSearchName() {
        return new PropertyName<String>("departmentSearchName");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _ImmDepartmentNames extends
            PropertyName<AbstractImmDepartment> {

        /**
         * インスタンスを構築します。
         */
        public _ImmDepartmentNames() {
        }
         ...
         *            名前
         */
        public _ImmDepartmentNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ImmDepartmentNames(final PropertyName<?> parent,
                final String name) {
            super(parent, name);
        }
         ...
         * @return departmentShortNameのプロパティ名
         */
        public PropertyName<String> departmentShortName() {
            return new PropertyName<String>(this, "departmentShortName");
        }
         ...
         * @return departmentSearchNameのプロパティ名
         */
        public PropertyName<String> departmentSearchName() {
            return new PropertyName<String>(this, "departmentSearchName");
        }
