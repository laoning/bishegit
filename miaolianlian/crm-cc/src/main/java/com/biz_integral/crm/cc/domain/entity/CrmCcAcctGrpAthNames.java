...
/**
 * {@link AbstractCrmCcAcctGrpAth}のプロパティ名の集合です。
 * 
 */
public class CrmCcAcctGrpAthNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcAcctGrpAthNames extends PropertyName<AbstractCrmCcAcctGrpAth> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcAcctGrpAthNames() {
        }
         ...
         *            名前
         */
        public _CrmCcAcctGrpAthNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcAcctGrpAthNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
