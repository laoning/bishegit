...
public final class EntryInitializeResponseModel {
     ...
     * 重要度の一覧
     */
    @XStreamAlias("importantLevelTypeList")
    public List<KeyValueBean> importantLevelTypeList = newArrayList();

    /**
     * 区分の一覧
     */
    @XStreamAlias("crmAccountTypeList")
    public List<KeyValueBean> crmAccountTypeList = newArrayList();

    /**
     * 取引種別の一覧
     */
    @XStreamAlias("dealClassList")
    public List<KeyValueBean> dealClassList = newArrayList();

    /**
     * 性別の一覧
     */
    @XStreamAlias("sexTypeList")
    public List<KeyValueBean> sexTypeList = newArrayList();
     ...
     * SFA利用フラグ
     */
    public String sfaFlag;

    /**
     * CRMアカウント追加情報利用フラグ
     */
    public String crmAccountAddInfoFlag;
