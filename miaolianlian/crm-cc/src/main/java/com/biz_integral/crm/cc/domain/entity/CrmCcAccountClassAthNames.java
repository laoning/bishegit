...
/**
 * {@link AbstractCrmCcAccountClassAth}のプロパティ名の集合です。
 * 
 */
public class CrmCcAccountClassAthNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcAccountClassAthNames extends PropertyName<AbstractCrmCcAccountClassAth> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcAccountClassAthNames() {
        }
         ...
         *            名前
         */
        public _CrmCcAccountClassAthNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcAccountClassAthNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
