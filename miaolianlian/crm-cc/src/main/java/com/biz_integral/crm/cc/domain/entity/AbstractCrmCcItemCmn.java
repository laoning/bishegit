...
public abstract class AbstractCrmCcItemCmn implements Serializable {
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcItemCmn> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
