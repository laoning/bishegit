...
public class ExportFileTask extends AsyncTaskSupport {
     ...
     */
    @BizContext
    public void asyncExportFile(AccountClassSearchCriteriaDto exportFileModel) {
        crmAccountClassLogic.createFile(exportFileModel);
    }
}
