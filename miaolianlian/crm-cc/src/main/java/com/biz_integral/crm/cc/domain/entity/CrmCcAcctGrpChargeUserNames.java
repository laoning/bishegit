...
/**
 * {@link AbstractCrmCcAcctGrpChargeUser}のプロパティ名の集合です。
 * 
 */
public class CrmCcAcctGrpChargeUserNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcAcctGrpChargeUserNames extends PropertyName<AbstractCrmCcAcctGrpChargeUser> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcAcctGrpChargeUserNames() {
        }
         ...
         *            名前
         */
        public _CrmCcAcctGrpChargeUserNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcAcctGrpChargeUserNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
