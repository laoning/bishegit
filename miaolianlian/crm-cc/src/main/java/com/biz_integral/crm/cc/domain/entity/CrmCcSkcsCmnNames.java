...
/**
 * {@link AbstractCrmCcSkcsCmn}のプロパティ名の集合です。
 * 
 */
...
public class CrmCcSkcsCmnNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcSkcsCmnNames extends PropertyName<AbstractCrmCcSkcsCmn> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcSkcsCmnNames() {
        }
         ...
         *            名前
         */
        public _CrmCcSkcsCmnNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcSkcsCmnNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
