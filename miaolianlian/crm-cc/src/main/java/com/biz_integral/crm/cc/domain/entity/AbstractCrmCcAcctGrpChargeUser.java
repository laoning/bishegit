...
@MappedSuperclass
@Table(
    name = "crm_cc_acct_grp_charge_user")
public abstract class AbstractCrmCcAcctGrpChargeUser implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAcctGrpChargeUser() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAcctGrpChargeUser> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
