...
@MappedSuperclass
@Table(
    name = "crm_cc_account_grp_attr")
public abstract class AbstractCrmCcAccountGrpAttr implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAccountGrpAttr() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccountGrpAttr> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
