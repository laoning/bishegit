...
/**
 * {@link AbstractCrmCcModule}のプロパティ名の集合です。
 * 
 */
public class CrmCcModuleNames {
    ...
    /**
     * moduleNameのプロパティ名を返します。
     * 
     * @return moduleNameのプロパティ名
     */
    public static PropertyName<String> moduleName() {
        return new PropertyName<String>("moduleName");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcModuleNames extends PropertyName<AbstractCrmCcModule> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcModuleNames() {
        }
         ...
         *            名前
         */
        public _CrmCcModuleNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcModuleNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return moduleNameのプロパティ名
         */
        public PropertyName<String> moduleName() {
            return new PropertyName<String>(this, "moduleName");
        }
