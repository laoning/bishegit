...
public abstract class AbstractCrmCcCountryCmn implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcCountryCmn() {
    }
    ...
    /** 国検索名 */
    @Column(name = "country_search_name",
            columnDefinition = "varchar2(1000)", 
            nullable = true, unique = false)
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcCountryCmn> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
