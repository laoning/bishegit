...
public abstract class AbstractCrmCcContactChargeUser implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcContactChargeUser() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcContactChargeUser> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
