...
/**
 * {@link AbstractCrmCcAccountModule}のプロパティ名の集合です。
 * 
 */
public class CrmCcAccountModuleNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcAccountModuleNames extends PropertyName<AbstractCrmCcAccountModule> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcAccountModuleNames() {
        }
         ...
         *            名前
         */
        public _CrmCcAccountModuleNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcAccountModuleNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
