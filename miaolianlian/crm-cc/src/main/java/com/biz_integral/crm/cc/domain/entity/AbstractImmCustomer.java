...
public abstract class AbstractImmCustomer implements Serializable {
    ...
    /** customerCdプロパティ */
    @Id
    @Column(name = "customer_cd", columnDefinition = "varchar2(100)", nullable = false, unique = false)
    ...
    /** customerNameプロパティ */
    @Column(name = "customer_name", columnDefinition = "varchar2(1000)", nullable = false, unique = false)
    private String customerName;

    /** customerShortNameプロパティ */
    @Column(name = "customer_short_name", columnDefinition = "varchar2(1000)", nullable = true, unique = false)
    private String customerShortName;

    /** customerSearchNameプロパティ */
    @Column(name = "customer_search_name", columnDefinition = "varchar2(1000)", nullable = true, unique = false)
    private String customerSearchName;

    /** chargePersonNameプロパティ */
    @Column(name = "charge_person_name", columnDefinition = "varchar2(1000)", nullable = true, unique = false)
    ...
    /**
     * customerSearchNameを設定します。
     * 
     * @param customerSearchName
     *            customerSearchName
     */
    ...
    /**
     * chargePersonNameを設定します。
     * 
     * @param chargePersonName
     *            chargePersonName
     */
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractImmCustomer> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
