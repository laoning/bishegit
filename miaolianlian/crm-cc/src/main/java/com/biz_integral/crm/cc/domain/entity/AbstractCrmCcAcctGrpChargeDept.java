...
@MappedSuperclass
@Table(
    name = "crm_cc_acct_grp_charge_dept")
public abstract class AbstractCrmCcAcctGrpChargeDept implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAcctGrpChargeDept() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAcctGrpChargeDept> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
