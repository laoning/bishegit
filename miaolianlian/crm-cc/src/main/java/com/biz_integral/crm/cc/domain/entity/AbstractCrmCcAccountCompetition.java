...
public abstract class AbstractCrmCcAccountCompetition implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAccountCompetition() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccountCompetition> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
