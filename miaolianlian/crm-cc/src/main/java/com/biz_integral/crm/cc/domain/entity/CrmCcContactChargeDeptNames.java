...
/**
 * {@link AbstractCrmCcContactChargeDept}のプロパティ名の集合です。
 * 
 */
...
public class CrmCcContactChargeDeptNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcContactChargeDeptNames extends PropertyName<AbstractCrmCcContactChargeDept> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcContactChargeDeptNames() {
        }
         ...
         *            名前
         */
        public _CrmCcContactChargeDeptNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcContactChargeDeptNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
