 ...
 * アカウント分類所属のロジックです。
 */
public interface CrmAccountClassAthLogic {
    ...
    /**
     * アカウント分類所属を論理削除します。<br>
     * 
     * @param crmCcAccountClassAth
     *            カウント分類所属
     */
    public abstract void delete(CrmCcAccountClassAth crmCcAccountClassAth);
