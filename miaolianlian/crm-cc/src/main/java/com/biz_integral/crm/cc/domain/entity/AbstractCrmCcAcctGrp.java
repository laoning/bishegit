...
public abstract class AbstractCrmCcAcctGrp implements Serializable {
    ...
    /** CRMアカウントグループ名 */
    @Column(name = "crm_account_group_name",
            columnDefinition = "varchar2(1000)", 
            nullable = false, unique = false)
    private String crmAccountGroupName;

    /** CRMアカウントグループ略称 */
    @Column(name = "crm_account_group_short_name",
            columnDefinition = "varchar2(1000)", 
            nullable = true, unique = false)
    private String crmAccountGroupShortName;

    /** CRMアカウントグループ検索名 */
    @Column(name = "crm_account_group_search_name",
            columnDefinition = "varchar2(1000)", 
            nullable = true, unique = false)
    private String crmAccountGroupSearchName;
     ...
     * CRMアカウントグループ名を返します。
     * 
     * @return CRMアカウントグループ名
     */
    public String getCrmAccountGroupName() {
        return crmAccountGroupName;
    }

    /**
     * CRMアカウントグループ名を設定します。
     * 
     * @param crmAccountGroupName CRMアカウントグループ名
     */
    public void setCrmAccountGroupName(String crmAccountGroupName) {
        this.crmAccountGroupName = crmAccountGroupName;
    }

    /**
     * CRMアカウントグループ略称を返します。
     * 
     * @return CRMアカウントグループ略称
     */
    public String getCrmAccountGroupShortName() {
        return crmAccountGroupShortName;
    }

    /**
     * CRMアカウントグループ略称を設定します。
     * 
     * @param crmAccountGroupShortName CRMアカウントグループ略称
     */
    public void setCrmAccountGroupShortName(String crmAccountGroupShortName) {
        this.crmAccountGroupShortName = crmAccountGroupShortName;
    }

    /**
     * CRMアカウントグループ検索名を返します。
     * 
     * @return CRMアカウントグループ検索名
     */
    public String getCrmAccountGroupSearchName() {
        return crmAccountGroupSearchName;
    }

    /**
     * CRMアカウントグループ検索名を設定します。
     * 
     * @param crmAccountGroupSearchName CRMアカウントグループ検索名
     */
    public void setCrmAccountGroupSearchName(String crmAccountGroupSearchName) {
        this.crmAccountGroupSearchName = crmAccountGroupSearchName;
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAcctGrp> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
