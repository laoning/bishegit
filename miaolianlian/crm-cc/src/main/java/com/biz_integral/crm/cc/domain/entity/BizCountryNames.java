...
/**
 * {@link AbstractBizCountry}のプロパティ名の集合です。
 * 
 */
@Generated(value = {
    "S2JDBC-Gen unknown",
    "org.seasar.extension.jdbc.gen.internal.model.NamesModelFactoryImpl" }, date = "2010/07/23 9:20:51")
public class BizCountryNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _BizCountryNames extends
            PropertyName<AbstractBizCountry> {

        /**
         * インスタンスを構築します。
         */
        public _BizCountryNames() {
        }
         ...
         *            名前
         */
        public _BizCountryNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _BizCountryNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
