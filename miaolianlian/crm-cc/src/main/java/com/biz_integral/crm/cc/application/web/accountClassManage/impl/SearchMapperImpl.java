...
import com.biz_integral.crm.cc.application.web.accountClassManage.SearchExportFileRequestModel;
import com.biz_integral.crm.cc.application.web.accountClassManage.SearchFilterRequestModel;
import com.biz_integral.crm.cc.application.web.accountClassManage.SearchFilterResponseModel;
import com.biz_integral.crm.cc.application.web.accountClassManage.SearchMapper;
...
public class SearchMapperImpl implements SearchMapper {
    ...
    public AccountClassSearchCriteriaDto convert(
        ...
        AccountClassSearchCriteriaDto criteria =
            beanMapper.map(request, AccountClassSearchCriteriaDto.class);
