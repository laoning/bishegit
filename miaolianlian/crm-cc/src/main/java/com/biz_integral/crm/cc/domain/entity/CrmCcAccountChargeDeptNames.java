...
/**
 * {@link AbstractCrmCcAccountChargeDept}のプロパティ名の集合です。
 * 
 */
...
public class CrmCcAccountChargeDeptNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcAccountChargeDeptNames extends PropertyName<AbstractCrmCcAccountChargeDept> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcAccountChargeDeptNames() {
        }
         ...
         *            名前
         */
        public _CrmCcAccountChargeDeptNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcAccountChargeDeptNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
