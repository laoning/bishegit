...
/**
 * {@link AbstractCrmCcDepartmentAthCmn}のプロパティ名の集合です。
 * 
 */
...
public class CrmCcDepartmentAthCmnNames {
    ...
    /**
     * departmentMainのプロパティ名を返します。
     * 
     * @return departmentMainのプロパティ名
     */
    public static PropertyName<String> departmentMain() {
        return new PropertyName<String>("departmentMain");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcDepartmentAthCmnNames extends PropertyName<AbstractCrmCcDepartmentAthCmn> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcDepartmentAthCmnNames() {
        }
         ...
         *            名前
         */
        public _CrmCcDepartmentAthCmnNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcDepartmentAthCmnNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return departmentMainのプロパティ名
         */
        public PropertyName<String> departmentMain() {
            return new PropertyName<String>(this, "departmentMain");
        }
