...
/**
 * PermitTypeを表す列挙です。<br/>
 * <p>
 * 利用を判断する（全般的に使用）
 * </p>
 */
@BizEnum(application = "crm", module = "cc")
public enum PermitType implements NamedEnumAware {
    ...
    /**
     * <p>
     * 区分値に対応する{@link PermitType }インスタンスを返却します。
     * </p>
     * 
     * <p>
     ...
     */
    public static PermitType getEnum(String value) {
        return EnumUtil.toNamedEnum(PermitType.class, value);
    }
}