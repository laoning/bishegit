...
public abstract class AbstractCrmCcAccount implements Serializable {
    ...
    /** CRMアカウント名 */
    @Column(name = "crm_account_name",
            columnDefinition = "varchar2(1000)", 
            nullable = true, unique = false)
    private String crmAccountName;

    /** CRMアカウント名（カナ） */
    @Column(name = "crm_account_name_kana",
            columnDefinition = "varchar2(1000)", 
            nullable = true, unique = false)
    private String crmAccountNameKana;

    /** CRMアカウント略称 */
    @Column(name = "crm_account_short_name",
            columnDefinition = "varchar2(1000)", 
            nullable = true, unique = false)
    private String crmAccountShortName;

    /** CRMアカウント検索名 */
    @Column(name = "crm_account_search_name",
            columnDefinition = "varchar2(1000)", 
            nullable = true, unique = false)
    private String crmAccountSearchName;
    ...
    /** 区分 */
    @Column(name = "crm_account_type",
            columnDefinition = "varchar2(100)", 
            nullable = true, unique = false)
    private String crmAccountType;

    /** CRMアカウント属性コード */
    @Column(name = "crm_account_attr_cd",
            columnDefinition = "varchar2(100)", 
            nullable = true, unique = false)
    private String crmAccountAttrCd;
    ...
    /** 新CRMアカウントコード */
    @Column(name = "new_crm_account_cd",
            columnDefinition = "varchar2(100)", 
            nullable = true, unique = false)
    private String newCrmAccountCd;
     ...
     * CRMアカウント名を設定します。
     * 
     * @param crmAccountName CRMアカウント名
     */
     ...
     * @return CRMアカウント名（カナ）
     */
    public String getCrmAccountNameKana() {
        return crmAccountNameKana;
    }

    /**
     * CRMアカウント名（カナ）を設定します。
     * 
     * @param crmAccountNameKana CRMアカウント名（カナ）
     */
    public void setCrmAccountNameKana(String crmAccountNameKana) {
        this.crmAccountNameKana = crmAccountNameKana;
    }
     ...
     * @return CRMアカウント略称
     */
    public String getCrmAccountShortName() {
        return crmAccountShortName;
    }

    /**
     * CRMアカウント略称を設定します。
     * 
     * @param crmAccountShortName CRMアカウント略称
     */
    public void setCrmAccountShortName(String crmAccountShortName) {
        this.crmAccountShortName = crmAccountShortName;
    }
     ...
     * @return CRMアカウント検索名
     */
    public String getCrmAccountSearchName() {
        return crmAccountSearchName;
    }

    /**
     * CRMアカウント検索名を設定します。
     * 
     * @param crmAccountSearchName CRMアカウント検索名
     */
    public void setCrmAccountSearchName(String crmAccountSearchName) {
        this.crmAccountSearchName = crmAccountSearchName;
    }
     ...
     * CRMアカウント属性コードを返します。
     * 
     * @return CRMアカウント属性コード
     */
    public String getCrmAccountAttrCd() {
        return crmAccountAttrCd;
    }

    /**
     * CRMアカウント属性コードを設定します。
     * 
     * @param crmAccountAttrCd CRMアカウント属性コード
     */
    public void setCrmAccountAttrCd(String crmAccountAttrCd) {
        this.crmAccountAttrCd = crmAccountAttrCd;
    }
     ...
     * @return 新CRMアカウントコード
     */
    public String getNewCrmAccountCd() {
        return newCrmAccountCd;
    }

    /**
     * 新CRMアカウントコードを設定します。
     * 
     * @param newCrmAccountCd 新CRMアカウントコード
     */
    public void setNewCrmAccountCd(String newCrmAccountCd) {
        this.newCrmAccountCd = newCrmAccountCd;
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccount> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
