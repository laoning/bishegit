...
/**
 * {@link AbstractCrmCcUserCmn}のプロパティ名の集合です。
 * 
 */
...
public class CrmCcUserCmnNames {
    ...
    /**
     * userSearchNameのプロパティ名を返します。
     * 
     * @return userSearchNameのプロパティ名
     */
    public static PropertyName<String> userSearchName() {
        return new PropertyName<String>("userSearchName");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcUserCmnNames extends PropertyName<AbstractCrmCcUserCmn> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcUserCmnNames() {
        }
         ...
         *            名前
         */
        public _CrmCcUserCmnNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcUserCmnNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return userSearchNameのプロパティ名
         */
        public PropertyName<String> userSearchName() {
            return new PropertyName<String>(this, "userSearchName");
        }
