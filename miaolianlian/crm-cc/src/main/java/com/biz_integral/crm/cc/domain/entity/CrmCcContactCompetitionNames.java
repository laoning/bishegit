...
/**
 * {@link AbstractCrmCcContactCompetition}のプロパティ名の集合です。
 * 
 */
...
public class CrmCcContactCompetitionNames {
    ...
    /**
     * crmContactCdのプロパティ名を返します。
     * 
     * @return crmContactCdのプロパティ名
     */
    public static PropertyName<String> crmContactCd() {
        return new PropertyName<String>("crmContactCd");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcContactCompetitionNames extends PropertyName<AbstractCrmCcContactCompetition> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcContactCompetitionNames() {
        }
         ...
         *            名前
         */
        public _CrmCcContactCompetitionNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcContactCompetitionNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return crmContactCdのプロパティ名
         */
        public PropertyName<String> crmContactCd() {
            return new PropertyName<String>(this, "crmContactCd");
        }
