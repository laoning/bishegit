...
/**
 * {@link AbstractCrmCcAccountClass}のプロパティ名の集合です。
 * 
 */
public class CrmCcAccountClassNames {
    ...
    /**
     * crmAccountClassNameのプロパティ名を返します。
     * 
     * @return crmAccountClassNameのプロパティ名
     */
    public static PropertyName<String> crmAccountClassName() {
        return new PropertyName<String>("crmAccountClassName");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcAccountClassNames extends PropertyName<AbstractCrmCcAccountClass> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcAccountClassNames() {
        }
         ...
         *            名前
         */
        public _CrmCcAccountClassNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcAccountClassNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return crmAccountClassNameのプロパティ名
         */
        public PropertyName<String> crmAccountClassName() {
            return new PropertyName<String>(this, "crmAccountClassName");
        }
