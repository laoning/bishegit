 ...
 * コンタクトクローラ基底クラス
 */
public abstract class CrmAccountCrawlerBase extends CrmBatchBase {
    ...
    protected void run(Properties args) {
        ...
        crawlerlogic.execute(getCrawlingType());
    ...
    protected String getApplicationId() {
        return CrmSolrConstans.DOCUMENT_INFO.CRM_ACCOUNT.applicationId();
    }
    ...
    protected String getModuleId() {
        return CrmSolrConstans.DOCUMENT_INFO.CRM_ACCOUNT.moduleId();
    }
