...
public abstract class AbstractCrmCcAccountContact implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAccountContact() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccountContact> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
