...
/**
 * {@link AbstractCrmCcAccountAttr}のプロパティ名の集合です。
 * 
 */
public class CrmCcAccountAttrNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcAccountAttrNames extends PropertyName<AbstractCrmCcAccountAttr> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcAccountAttrNames() {
        }
         ...
         *            名前
         */
        public _CrmCcAccountAttrNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcAccountAttrNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
