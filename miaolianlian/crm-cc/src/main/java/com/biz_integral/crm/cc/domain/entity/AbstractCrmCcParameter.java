...
public abstract class AbstractCrmCcParameter implements Serializable {
    ...
    /** パラメータ桁数 */
    @Column(name = "parameter_digits",
            columnDefinition = "number(12,6)", 
            nullable = false, unique = false)
    private BigDecimal parameterDigits;
     ...
     * パラメータ分類を設定します。
     * 
     * @param parameterCategory パラメータ分類
     */
     ...
     * パラメータ型区分を設定します。
     * 
     * @param parameterDataType パラメータ型区分
     */
     ...
     * @return パラメータ桁数
     */
    public BigDecimal getParameterDigits() {
        return parameterDigits;
    }

    /**
     * パラメータ桁数を設定します。
     * 
     * @param parameterDigits パラメータ桁数
     */
    public void setParameterDigits(BigDecimal parameterDigits) {
        this.parameterDigits = parameterDigits;
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcParameter> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
