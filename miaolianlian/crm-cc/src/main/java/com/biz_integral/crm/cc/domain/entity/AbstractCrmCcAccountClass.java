...
@MappedSuperclass
@Table(
    name = "crm_cc_account_class")
public abstract class AbstractCrmCcAccountClass implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAccountClass() {
    }
    ...
    /** CRMアカウント分類名 */
    @Column(name = "crm_account_class_name",
            columnDefinition = "varchar2(1000)", 
            nullable = true, unique = false)
    private String crmAccountClassName;
     ...
     * @return CRMアカウント分類名
     */
    public String getCrmAccountClassName() {
        return crmAccountClassName;
    }

    /**
     * CRMアカウント分類名を設定します。
     * 
     * @param crmAccountClassName CRMアカウント分類名
     */
    public void setCrmAccountClassName(String crmAccountClassName) {
        this.crmAccountClassName = crmAccountClassName;
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccountClass> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
