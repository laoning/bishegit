...
/**
 * {@link AbstractCrmCcContactChargeUser}のプロパティ名の集合です。
 * 
 */
...
public class CrmCcContactChargeUserNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcContactChargeUserNames extends PropertyName<AbstractCrmCcContactChargeUser> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcContactChargeUserNames() {
        }
         ...
         *            名前
         */
        public _CrmCcContactChargeUserNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcContactChargeUserNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
