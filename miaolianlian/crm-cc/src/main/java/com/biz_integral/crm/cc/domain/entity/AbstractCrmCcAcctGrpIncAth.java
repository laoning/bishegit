...
@MappedSuperclass
@Table(
    name = "crm_cc_acct_grp_inc_ath")
public abstract class AbstractCrmCcAcctGrpIncAth implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAcctGrpIncAth() {
    }
    ...
    /** 親CRMアカウントグループコード */
    @Id
    @Column(name = "parent_crm_account_group_cd",
            columnDefinition = "varchar2(100)", 
            nullable = false, unique = false)
    private String parentCrmAccountGroupCd;
    ...
    /**
     * 親CRMアカウントグループコードを返します。
     * 
     * @return 親CRMアカウントグループコード
     */
    public String getParentCrmAccountGroupCd() {
        return parentCrmAccountGroupCd;
    }

    /**
     * 親CRMアカウントグループコードを設定します。
     * 
     * @param parentCrmAccountGroupCd 親CRMアカウントグループコード
     */
    public void setParentCrmAccountGroupCd(String parentCrmAccountGroupCd) {
        this.parentCrmAccountGroupCd = parentCrmAccountGroupCd;
    }
    ...
    public int hashCode() {
        ...
        builder.append(parentCrmAccountGroupCd);
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAcctGrpIncAth> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
