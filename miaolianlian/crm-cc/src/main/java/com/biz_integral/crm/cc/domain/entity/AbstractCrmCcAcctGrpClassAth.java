...
@MappedSuperclass
@Table(
    name = "crm_cc_acct_grp_class_ath")
public abstract class AbstractCrmCcAcctGrpClassAth implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAcctGrpClassAth() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAcctGrpClassAth> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
