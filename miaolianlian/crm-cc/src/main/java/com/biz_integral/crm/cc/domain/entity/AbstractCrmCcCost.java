...
public abstract class AbstractCrmCcCost implements Serializable {
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcCost> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
