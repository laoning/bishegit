...
/**
 * {@link AbstractCrmCcAcctGrpIncAth}のプロパティ名の集合です。
 * 
 */
public class CrmCcAcctGrpIncAthNames {
    ...
    /**
     * parentCrmAccountGroupCdのプロパティ名を返します。
     * 
     * @return parentCrmAccountGroupCdのプロパティ名
     */
    public static PropertyName<String> parentCrmAccountGroupCd() {
        return new PropertyName<String>("parentCrmAccountGroupCd");
    }
    ...
    /**
     * rootFlagのプロパティ名を返します。
     * 
     * @return rootFlagのプロパティ名
     */
    public static PropertyName<Boolean> rootFlag() {
        return new PropertyName<Boolean>("rootFlag");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcAcctGrpIncAthNames extends PropertyName<AbstractCrmCcAcctGrpIncAth> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcAcctGrpIncAthNames() {
        }
         ...
         *            名前
         */
        public _CrmCcAcctGrpIncAthNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcAcctGrpIncAthNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return parentCrmAccountGroupCdのプロパティ名
         */
        public PropertyName<String> parentCrmAccountGroupCd() {
            return new PropertyName<String>(this, "parentCrmAccountGroupCd");
        }
         ...
         * @return rootFlagのプロパティ名
         */
        public PropertyName<Boolean> rootFlag() {
            return new PropertyName<Boolean>(this, "rootFlag");
        }
