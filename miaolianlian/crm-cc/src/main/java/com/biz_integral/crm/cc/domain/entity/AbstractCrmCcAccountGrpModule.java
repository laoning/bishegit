...
public abstract class AbstractCrmCcAccountGrpModule implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAccountGrpModule() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccountGrpModule> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
