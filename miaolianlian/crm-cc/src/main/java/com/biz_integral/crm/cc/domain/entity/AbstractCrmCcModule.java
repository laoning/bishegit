...
@Table(
    name = "crm_cc_module")
public abstract class AbstractCrmCcModule implements Serializable {
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcModule> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
