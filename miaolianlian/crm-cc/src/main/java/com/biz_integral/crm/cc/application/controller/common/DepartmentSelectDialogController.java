...
/**
 * 組織選択ダイアログ検索画面のコントローラです。
 */
public class DepartmentSelectDialogController {
     ...
     */
    @Execute
    public DepartmentSelectDialogInitializeResponseModel initialize() {
        DepartmentSelectDialogInitializeResponseModel model =
            new DepartmentSelectDialogInitializeResponseModel();
    ...
    public PagingResponse<DepartmentDialogFilterResponseModel> filter(
        ...
        PagingResult<CrmCcDepartmentCmn> pagingResult =
            departmentDialogLogic.getEntityListTree(criteria);
