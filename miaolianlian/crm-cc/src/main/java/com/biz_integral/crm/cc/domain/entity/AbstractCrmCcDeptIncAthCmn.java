...
public abstract class AbstractCrmCcDeptIncAthCmn implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcDeptIncAthCmn() {
    }
    ...
    /** 親組織コード */
    @Id
    @Column(name = "parent_department_cd",
            columnDefinition = "varchar2(100)", 
            nullable = false, unique = false)
     ...
     * @return 親組織コード
     */
    public String getParentDepartmentCd() {
        return parentDepartmentCd;
    }
     ...
     */
    public void setParentDepartmentCd(String parentDepartmentCd) {
        this.parentDepartmentCd = parentDepartmentCd;
    }
    ...
    public int hashCode() {
        ...
        builder.append(parentDepartmentCd);
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcDeptIncAthCmn> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
