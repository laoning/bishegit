...
@MappedSuperclass
@Table(
    name = "crm_cc_department_ath_cmn")
@Generated(
    value = {
        "S2JDBC-Gen unknown", 
...
public abstract class AbstractCrmCcDepartmentAthCmn implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcDepartmentAthCmn() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcDepartmentAthCmn> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
