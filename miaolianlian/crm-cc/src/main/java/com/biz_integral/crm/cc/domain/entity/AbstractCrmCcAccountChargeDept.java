...
@MappedSuperclass
@Table(
    name = "crm_cc_account_charge_dept")
@Generated(
    value = {
        "S2JDBC-Gen unknown", 
...
public abstract class AbstractCrmCcAccountChargeDept implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAccountChargeDept() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccountChargeDept> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
