...
public abstract class AbstractCrmCcAccountModule implements Serializable {
     ...
     * デフォルト・コンストラクタ
     */
    public AbstractCrmCcAccountModule() {
    }
     ...
     *             判定できなかった場合
     */
    public <T extends AbstractCrmCcAccountModule> boolean isTheSame(T entity)
        throws UnsupportedOperationException {
