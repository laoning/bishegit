...
/**
 * {@link AbstractCrmCcDepartmentCmn}のプロパティ名の集合です。
 * 
 */
...
public class CrmCcDepartmentCmnNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _CrmCcDepartmentCmnNames extends PropertyName<AbstractCrmCcDepartmentCmn> {

        /**
         * インスタンスを構築します。
         */
        public _CrmCcDepartmentCmnNames() {
        }
         ...
         *            名前
         */
        public _CrmCcDepartmentCmnNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _CrmCcDepartmentCmnNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
